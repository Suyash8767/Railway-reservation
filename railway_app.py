...
cursor.execute("INSERT OR IGNORE INTO trains VALUES(103,'Superfast','Pune','solapur')")
cursor.execute("INSERT OR IGNORE INTO trains VALUES(104,'Superfast','solapur','nashik')")


# create seats (20 seats each coach)
for train in [101,102,103,104]:
...
# ---------------- BOOK ----------------
    ...
    seat_choice = st.number_input("Preferred Seat Number (1-105)",1,105)
